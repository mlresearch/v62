...
abstract: In the gambling foundation of probability theory, rationality requires that
  ...
  task. In fact, even if we restrict the gambles to be polynomials in $\mathbbR^n$,
  the problem of determining nonnegativity is NP-hard. The aim of this paper is to
  develop a \textitcomputable theory of desirable gambles. Instead of requiring the
  ...
  We call this new criterion \textitbounded rationality.
crossref: isipta17
